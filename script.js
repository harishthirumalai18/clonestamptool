...
function setSourcePoint() {
    canvas.addEventListener('mousemove', getSourcePoint);
}

function getSourcePoint(e) {
    sourcePointX = e.clientX - canvas.offsetLeft;
    sourcePointY = e.clientY - canvas.offsetTop;
}

function pasteSourcePoint() {
    if (sourcePointX && sourcePointY) {
        ctx.drawImage(canvas, sourcePointX, sourcePointY, 50, 50, 0, 0, 50, 50);
    }
    clearSourcePoint();
}
...
function clearSourcePoint() {
    sourcePointX = null;
    sourcePointY = null;
    canvas.removeEventListener('mousemove', getSourcePoint);
}
